	...
	window.touchSlider = function(options) {
		...
		function changedView(index) {
			pagination.removeClass(options.currentClass)
				...
				//add here the line. here you can add your event with the help of index.
			$(".changeview").find(">div").removeClass("changeviewdiv").eq(index).addClass("changeviewdiv");
		}
